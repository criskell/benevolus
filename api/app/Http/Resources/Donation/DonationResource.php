...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'thankYouMessage', type: 'string', nullable: true),
        new OA\Property(property: 'thankedAt', type: 'string', format: 'date-time', nullable: true),
